...
ALTER TABLE `orders` ADD CONSTRAINT `FK_reservation_participants_TO_orders_1` FOREIGN KEY (
...
ALTER TABLE `reservation_participants` ADD CONSTRAINT `FK_reservations_TO_reservation_participants_1` FOREIGN KEY (
                                                                                                                   `reservation_id`
    )
    REFERENCES `reservations` (
                               `reservation_id`
