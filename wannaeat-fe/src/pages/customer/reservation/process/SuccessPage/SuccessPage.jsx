...
const SuccessPage = () => {
    ...
    const {selectedDate, selectedStartTime, selectedEndTime, selectedHeadCount, selectedSeatNumber} = useTimeSelectStore();
    ...
    return (
        <SuccessPageContainer>
            ...
            <ReservationInfoWrapper>
                ...
                <Button size="long" height={'7vh'} outlined={true} fontWeight={900} >{selectedDate} {selectedStartTime} ~ {selectedEndTime}</Button>
                <Button size="long" height={'7vh'} outlined={true} fontWeight={900} >{selectedHeadCount}명 좌석 {selectedSeatNumber}</Button>
            </ReservationInfoWrapper>
            <LinkInfoWrapper>
                <LinkInfoTitle>링크를 단톡방에 공유해주세요</LinkInfoTitle>
                <LinkInfoTextWrapper>
                    <LinkInfoText>{link}</LinkInfoText>
                    <LinkInfoButton onClick={handleCopyButtonClick}><img src={paper}/></LinkInfoButton>
                </LinkInfoTextWrapper>
            </LinkInfoWrapper>
            <ButtonWrapper>
