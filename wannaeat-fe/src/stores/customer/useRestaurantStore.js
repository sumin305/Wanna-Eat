  ...
  setRestaurant: async (id) => {
    ...
    if (result.status === 200) {
      ...
      set({
        ...
        breakEndTime: restaurant.breakEndTime ? restaurant.breakEndTime.substring(0, 5) : '',
        breakStartTime: restaurant.breakStartTime ? restaurant.breakStartTime.substring(0, 5) : '',
        ...
        maxReservationTime: restaurant.maxReservationTime ? restaurant.maxReservationTime : '',
        ...
        restaurantCloseTime: restaurant.restaurantCloseTime ? restaurant.restaurantCloseTime.substring(0, 5) : '',
        restaurantDescription: restaurant.restaurantDescription || '',
        restaurantName: restaurant.restaurantName || 'erw',
        restaurantOpenTime: restaurant.restaurantOpenTime ? restaurant.restaurantOpenTime.substring(0, 5) : '',
